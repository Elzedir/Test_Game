...
public class Player : Actor
{
    ...
    {
        // When the SwapSprite function is called, change the playerSprite in the game manager
    ...
    {
        // When we call this function, set the player's level at the following.
        // The integer i starts at 0, and when the "level" increases, increase "i" too,
        // then call OnLevelUp
    ...
    protected void Status()
    {
        while (berserk)
        {
            AbilityManager.instance.Charge(closestEnemy, playerBody);
        }
    }
}
